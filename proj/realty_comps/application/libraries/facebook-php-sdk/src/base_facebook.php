...
abstract class BaseFacebook
{
  ...
  protected function getUserAccessToken() {
    ...
    echo "CODE: ". $code . " ";
    echo "<Br >";
    echo "persistant code: " . $this->getPersistentData('code');
    echo "<Br >";
    echo " code: ". ($code && $code != $this->getPersistentData('code') );
    echo "<Br >";
    echo "persitant access_token: " . $this->getPersistentData('access_token');
    echo "<Br >";
  ...
  protected function getUserFromAvailableData() {
    ...
    echo "<br />";
    echo "persisted_access_token: ". $persisted_access_token;
    echo "<br />";
    ...
    echo "<br />";
    echo "<br />";
    echo "TFAL: ". ( $access_token && $access_token != $this->getApplicationAccessToken() && !($user && $persisted_access_token == $access_token) );
    echo "<br />";
  ...
  protected function getCode() {
    ...
    echo "<br />";
    echo " REQUEST STATE: " . $_REQUEST['state'];
    echo "<br />";
    echo "<br />";
    echo "<br />";
  ...
  */
  protected function getCode() {
    ...
    echo " STATE: ". $this->state;
    echo "<br />";
    echo " SERVER_INFO STATE: " . $server_info['state'];
  ...
  protected function getAccessTokenFromCode($code, $redirect_uri = null) {
    ...
    try {
      ...
      // In any event, we don't have an access token, so say so.
      echo "<br />";
      echo "getAccessTokenFromCode: exception: ";
      echo "<br />";
      echo $e;
      echo "<br />";
    ...
    if (empty($access_token_response)) {
      echo "<br />";
      echo "empty($access_token_response): ";
      echo "<br />";
  ...
  protected static function errorLog($msg) {
    ...
    if (php_sapi_name() != 'cli') {
      error_log($msg."\n", 3, "application/logs/fb_error_logs");
    }
